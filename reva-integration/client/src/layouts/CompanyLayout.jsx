// client/src/layouts/CompanyLayout.jsx
...
const CompanyLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/company/requirements', icon: Package, label: 'Requirements' },
    { path: '/company/contracts', icon: FileText, label: 'Contracts' },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white border-b z-50">
        <div className="flex items-center justify-between p-4">
          <h1 className="text-xl font-bold text-secondary">AgriLink</h1>
          <button
      ...
      >
        <div className="p-6 border-b">
          <h1 className="text-2xl font-bold text-secondary">AgriLink</h1>
          <p className="text-sm text-gray-600 mt-1">
            <TranslatedText>Company Portal</TranslatedText>
          </p>
        </div>
